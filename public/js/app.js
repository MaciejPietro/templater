...
/***/ "./resources/js/components/copyToClipboard.js":
/*!****************************************************!*\
  !*** ./resources/js/components/copyToClipboard.js ***!
  \****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__() {
  var wrapper = document.querySelector('.classical-template');
  var btn = document.querySelector('.copy-to-clipboard');
  if (wrapper && btn) {
    btn.addEventListener('click', function () {
      navigator.clipboard.write([new ClipboardItem({
        'text/plain': new Blob([wrapper.innerText], {
          type: 'text/plain'
        }),
        'text/html': new Blob([wrapper.innerHTML], {
          type: 'text/html'
        })
      })]);
